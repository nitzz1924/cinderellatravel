...
<div class="hero-2" id="hero">
    ...
    <div class="swiper hero-slider-2" id="heroSlide2">
        ...
        <div class="th-swiper-custom">
            ...
            <div class="hero-icon"><button data-slider-prev="#heroSlide2, #heroSlide3" class="hero-arrow slider-prev"><img src="assets/img/icon/hero-arrow-left.svg" alt=""></button>
    ...
    <div class="scroll-down"><a href="#destination-sec" class="scroll-wrap"><span><img src="assets/img/icon/down-arrow.svg" alt=""></span>Scroll Down</a></div>
</div>
...
<section class="category-area bg-top-center" data-bg-src="assets/img/bg/category_bg_1.png">
    <div class="container th-container">
        ...
        <div class="swiper th-slider has-shadow categorySlider" id="categorySlider1" data-bg-src="assets/img/bg/category_bg_1.png" data-slider-options='{"spaceBetween": "50","breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"3"},"1400":{"slidesPerView":"5"}}}'>
            <div class="swiper-wrapper">
                <div class="swiper-slide">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="destination-box gsap-cursor">
                        <div class="destination-img"><img src="assets/img/destination/destination_1_1.jpg" alt="destination image">
                            <div class="destination-content">
                                <div class="media-left">
                                    <h4 class="box-title"><a href="#">Maldives</a></h4><span class="destination-subtitle">15 Holiday Packages</span>
                                </div>
                ...
                <div class="swiper-slide">
                    <div class="destination-box gsap-cursor">
                        <div class="destination-img"><img src="assets/img/destination/destination_1_2.jpg" alt="destination image">
                            <div class="destination-content">
                                <div class="media-left">
                                    <h4 class="box-title"><a href="#">Thailand</a></h4><span class="destination-subtitle">22 Holiday Packages</span>
                                </div>
                                <div class=""><a href="#" class="th-btn style2 th-icon">View Packages</a>
                                </div>
                            </div>
                ...
                <div class="swiper-slide">
                    <div class="destination-box gsap-cursor">
                        <div class="destination-img"><img src="assets/img/destination/destination_1_3.jpg" alt="destination image">
                            <div class="destination-content">
                                <div class="media-left">
                                    <h4 class="box-title"><a href="#">Belgium</a></h4><span class="destination-subtitle">25 Holiday Packages</span>
                                </div>
                                <div class=""><a href="#" class="th-btn style2 th-icon">View Packages</a>
                                </div>
                            </div>
                ...
                <div class="swiper-slide">
                    <div class="destination-box gsap-cursor">
                        <div class="destination-img"><img src="assets/img/destination/destination_1_4.jpg" alt="destination image">
                            <div class="destination-content">
                                <div class="media-left">
                                    <h4 class="box-title"><a href="#">Bali</a></h4><span class="destination-subtitle">28 Holiday Packages</span>
                                </div>
                                <div class=""><a href="#" class="th-btn style2 th-icon">View Packages</a>
                                </div>
                            </div>
                ...
                <div class="swiper-slide">
                    <div class="destination-box gsap-cursor">
                        <div class="destination-img"><img src="assets/img/destination/destination_1_5.jpg" alt="destination image">
                            <div class="destination-content">
                                <div class="media-left">
                                    <h4 class="box-title"><a href="#">Dubai</a></h4><span class="destination-subtitle">30 Holiday Packages</span>
                                </div>
                                <div class=""><a href="#" class="th-btn style2 th-icon">View Packages</a>
                                </div>
                            </div>
            ...
            <div class="col-md-6 col-lg-2">
                <div class="gallery-card">
                    <div class="box-img global-img"><a href="assets/img/gallery/gallery_1_1.jpg" class="popup-image">
                            <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div><img src="assets/img/gallery/gallery_1_1.jpg" alt="gallery image">
                        </a></div>
                </div>
            </div>
            <div class="col-md-6 col-lg-2">
                <div class="gallery-card">
                    <div class="box-img global-img"><a href="assets/img/gallery/gallery_1_2.jpg" class="popup-image">
                            <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div><img src="assets/img/gallery/gallery_1_2.jpg" alt="gallery image">
                        </a></div>
                </div>
                <div class="gallery-card">
                    <div class="box-img global-img"><a href="assets/img/gallery/gallery_1_3.jpg" class="popup-image">
                            <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div><img src="assets/img/gallery/gallery_1_3.jpg" alt="gallery image">
                        </a></div>
                </div>
            </div>
            <div class="col-md-6 col-lg-2">
                <div class="gallery-card">
                    <div class="box-img global-img"><a href="assets/img/gallery/gallery_1_4.jpg" class="popup-image">
                            <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div><img src="assets/img/gallery/gallery_1_4.jpg" alt="gallery image">
                        </a></div>
                </div>
            </div>
            <div class="col-md-6 col-lg-2">
                <div class="gallery-card">
                    <div class="box-img global-img"><a href="assets/img/gallery/gallery_1_5.jpg" class="popup-image">
                            <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div><img src="assets/img/gallery/gallery_1_5.jpg" alt="gallery image">
                        </a></div>
                </div>
                <div class="gallery-card">
                    <div class="box-img global-img"><a href="assets/img/gallery/gallery_1_6.jpg" class="popup-image">
                            <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div><img src="assets/img/gallery/gallery_1_6.jpg" alt="gallery image">
                        </a></div>
                </div>
            </div>
            <div class="col-md-6 col-lg-2">
                <div class="gallery-card">
                    <div class="box-img global-img"><a href="assets/img/gallery/gallery_1_7.jpg" class="popup-image">
                            <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div><img src="assets/img/gallery/gallery_1_7.jpg" alt="gallery image">
                        </a></div>
                </div>
            </div>
        </div>
                        ...
                        <div class="testi-card">
                            <div class="testi-card_wrapper">
                                <div class="testi-card_profile">
                                    <div class="testi-card_avater"><img src="assets/img/testimonial/testi_1_2.jpg" alt="testimonial"></div>
                                    <div class="media-body">
                                        <h3 class="box-title">Sophia Lee</h3><span class="testi-card_desig">Traveller</span>
                                    </div>
                                </div>
                                <div class="testi-card_review"><i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i></div>
                            </div>
...
<div class="brand-area overflow-hidden space">
    <div class="container-fluid th-container space">
        ...
        <div class="swiper th-slider brandSlider1" id="brandSlider1" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"2"},"768":{"slidesPerView":"3"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"6"},"1400":{"slidesPerView":"8"}}}'>
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Aegean-Airlines-300x189.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Aegean-Airlines-300x189.png" alt="Brand Logo"></a></div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Air-france-300x169.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Air-france-300x169.png" alt="Brand Logo"></a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Air-india-300x180.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Air-india-300x180.png" alt="Brand Logo"></a></div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Air-peace-airlines.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Air-peace-airlines.png" alt="Brand Logo"></a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Air-Senegal-300x86.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Air-Senegal-300x86.png" alt="Brand Logo"></a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Asky-300x125.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Asky-300x125.png" alt="Brand Logo"></a></div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/British-Airlines-300x169.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/British-Airlines-300x169.png" alt="Brand Logo"></a></div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Brussels-airlines-300x71.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Brussels-airlines-300x71.png" alt="Brand Logo"></a></div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Egypt-air-300x164.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Egypt-air-300x164.png" alt="Brand Logo"></a></div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Emirates-airlines-300x169.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Emirates-airlines-300x169.png" alt="Brand Logo"></a></div>
                </div>
            </div>
        </div>
        <div class="swiper th-slider brandSlider1" id="brandSlider1" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"2"},"768":{"slidesPerView":"3"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"6"},"1400":{"slidesPerView":"8"}}}'>
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Ethiopia.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Ethiopia.png" alt="Brand Logo"></a></div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Fly-Dubai-300x169.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Fly-Dubai-300x169.png" alt="Brand Logo"></a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Kenya-300x200.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Kenya-300x200.png" alt="Brand Logo"></a></div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Klm-royal-Dutch-airlines.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Klm-royal-Dutch-airlines.png" alt="Brand Logo"></a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Qatar-airlines-300x102.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Qatar-airlines-300x102.png" alt="Brand Logo"></a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Royal-air-morroc.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Royal-air-morroc.png" alt="Brand Logo"></a></div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/South-Africa-Airlines-300x119.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/South-Africa-Airlines-300x119.png" alt="Brand Logo"></a></div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Tap-Portugal-air-300x53.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Tap-Portugal-air-300x53.png" alt="Brand Logo"></a></div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Turkish-airlines-300x81.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Turkish-airlines-300x81.png" alt="Brand Logo"></a></div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/United-airlines.svg" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/United-airlines.svg" alt="Brand Logo"></a></div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-box"><a href="#"><img class="original" src="assets/img/airlines/Virgin-Atlantic-300x188.png" alt="Brand Logo"> <img class="gray" src="assets/img/airlines/Virgin-Atlantic-300x188.png" alt="Brand Logo"></a></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="sec_title_static">
                    <div class="sec_title_wrap">
                        <div class="title-area text-center text-lg-start pe-xl-5"><span class="sub-title">Travel Tips
                                & Insights</span>
                            <h2 class="sec-title">Latest from Cinderella’s Travel Blog</h2><a href="#" class="th-btn style4 th-icon">Read More Articles</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="blog-grid4-static-wrap">
                    <div class="col-12 blog-grid4_wrapp">
                        <div class="blog-grid4 th-ani style4 mt-24">
                            <div class="box-content">
                                <div class="blog-meta"><a class="author" href="#">Aug 20, 2025</a> <a href="#">8 min read</a></div>
                            ...
                            <div class="blog-img global-img"><img src="assets/img/blog/blog_9_2.jpg" alt="blog image"></div>
                        </div>
                    </div>
                    <div class="col-12 blog-grid4_wrapp">
                        <div class="blog-grid4 th-ani style4 mt-24">
                    ...
                    <div class="col-12 blog-grid4_wrapp">
                        <div class="blog-grid4 th-ani style4 mt-24">
                            ...
                            <div class="blog-img global-img"><img src="assets/img/blog/blog_9_3.jpg" alt="blog image"></div>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="bg-smoke overflow-hidden space arrow-wrap" id="blog-sec">
    <div class="container shape-mockup-wrap">
        <div class="mb-30 text-center text-md-start">
            <div class="row align-items-center justify-content-between">
                <div class="col-md-7">
                    <div class="title-area mb-md-0"><span class="sub-title">Travel News & Tips</span>
                        <h2 class="sec-title">Latest Blogs & Travel Insights</h2>
                    </div>
                </div>
                <div class="col-md-auto"><a href="{{route('blogs')}}" class="th-btn style4 th-icon">See More Articles</a></div>
            </div>
        </div>
        <div class="slider-area">
            <div class="swiper th-slider has-shadow swiper-initialized swiper-horizontal swiper-backface-hidden" id="blogSlider1" data-slider-options="{&quot;breakpoints&quot;:{&quot;0&quot;:{&quot;slidesPerView&quot;:1},&quot;576&quot;:{&quot;slidesPerView&quot;:&quot;1&quot;},&quot;768&quot;:{&quot;slidesPerView&quot;:&quot;2&quot;},&quot;992&quot;:{&quot;slidesPerView&quot;:&quot;2&quot;},&quot;1200&quot;:{&quot;slidesPerView&quot;:&quot;3&quot;}}}">
                <div class="swiper-wrapper" id="swiper-wrapper-1867f0e2d5ba45810" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-1344px, 0px, 0px); transition-delay: 0ms;">
                    @foreach ($blogs as $data)
                    <div class="swiper-slide" style="width: 424px; margin-right: 24px;" role="group" aria-label="5 / 6" data-swiper-slide-index="4">
                        <div class="blog-box th-ani">
                            <div class="blog-img global-img"><img src="{{asset('adminAssets/images/Blogs/'.$data->blogthumbnail)}}" alt="blog image"></div>
                            <div class="blog-box_content">
                                <div class="blog-meta">
                                    <a class="author" href="{{route('blogdetail',['id'=>$data->id])}}">{{ $data->created_at->format('F j Y') }}</a>
                                </div>
                                <h3 class="box-title"><a href="{{route('blogdetail',['id'=>$data->id])}}">{{Str::limit($data->blogname,50)}}</a></h3><a href="{{route('blogdetail',['id'=>$data->id])}}" class="th-btn style4 th-icon">Read More</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
        ...
        <div class="shape-mockup shape1 d-none d-xxl-block" style="bottom: 20%; left: -17%;"><img src="assets/img/shape/shape_1.png" alt="shape"></div>
        <div class="shape-mockup shape2 d-none d-xl-block" style="bottom: 5%; left: -17%;"><img src="assets/img/shape/shape_2.png" alt="shape"></div>
        <div class="shape-mockup shape3 d-none d-xxl-block" style="bottom: 12%; left: -10%;"><img src="assets/img/shape/shape_3.png" alt="shape"></div>
    </div>
</section>
@endsection
