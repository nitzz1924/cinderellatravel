...
<body>
    ...
    <div id="preloader" class="preloader"><button class="th-btn preloaderCls">Cancel Preloader</button>
        ...
        <div id="loader" class="th-preloader">
            <div class="animation-preloader">
                <div class="txt-loading"><span preloader-text="T" class="characters">T </span><span
                        preloader-text="O" class="characters">O </span><span preloader-text="U" class="characters">U
                    </span><span preloader-text="R" class="characters">R </span><span preloader-text="M"
        ...
        <div class="sidemenu-content"><button class="closeButton sideMenuCls"><i class="far fa-times"></i></button>
            <div class="widget">
                <div class="th-widget-about">
                    <div class="about-logo"><a href="home-travel.html"><img src="assets/img/logo2.svg"
                                alt="Tourm"></a>
                    </div>
    ...
    <div class="th-menu-wrapper onepage-nav">
        <div class="th-menu-area text-center"><button class="th-menu-toggle"><i class="fal fa-times"></i></button>
            <div class="mobile-logo"><a href="home-travel.html"><img src="assets/img/logo2.svg" alt="Tourm"></a>
            </div>
                ...
                <div class="container th-container">
                    <div class="row align-items-center justify-content-between">
                                                    ...
                                                    <div class="row gy-4">
                                                            ...
                                                            <div class="mega-menu-box">
                                                                <div class="mega-menu-img"><img
                                                                    ...
                                                                    <div class="btn-wrap"><a target="_blank"
                                                                            href="index-2.html" class="th-btn">View
                                                                            Demo</a></div>
                                                                </div>
                                                                <h3 class="mega-menu-title"><a
                                                                        href="index-2.html"><span>01.</span>Home
                                                                        Travel</a></h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                <div class="mega-menu-img"><img
                                                                        ...
                                                                        alt="Home Two">
                                                                    <div class="btn-wrap"><a target="_blank"
                                                                            href="home-tour.html" class="th-btn">View
                                                                            Demo</a></div>
                                                                </div>
                                                                <h3 class="mega-menu-title"><a
                                                                        href="home-tour.html"><span>02.</span>Home
                                                                        Tour</a></h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                ...
                                                                <h3 class="mega-menu-title"><a
                                                                        href="home-agency.html"><span>03.</span>Home
                                                                        Agency</a></h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                <div class="mega-menu-img"><img
                                                                        ...
                                                                        alt="Home Four">
                                                                    <div class="btn-wrap"><a target="_blank"
                                                                            href="home-yacht.html" class="th-btn">View
                                                                            Demo</a></div>
                                                                </div>
                                                                <h3 class="mega-menu-title"><a
                                                                        href="home-yacht.html"><span>04.</span>Home
                                                                        Yacht</a></h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                <div class="mega-menu-img"><img
                                                                        ...
                                                                        alt="Home Five">
                                                                    <div class="btn-wrap"><a target="_blank"
                                                                            href="home-beach.html" class="th-btn">View
                                                                            Demo</a></div>
                                                                </div>
                                                                <h3 class="mega-menu-title"><a
                                                                        href="home-beach.html"><span>05.</span>Home
                                                                        Beach</a></h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                ...
                                                                <h3 class="mega-menu-title"><a
                                                                        href="home-resort.html"><span>06.</span>Home
                                                                        resort</a></h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                ...
                                                                <h3 class="mega-menu-title"><a
                                                                        href="home-countryside-hotel.html"><span>07.</span>Home
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                ...
                                                                <h3 class="mega-menu-title"><a
                                                                        href="home-forest.html"><span>08.</span>Home
                                                                        Forest</a></h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                ...
                                                                <h3 class="mega-menu-title"><a
                                                                        href="home-hiking.html"><span>09.</span>Home
                                                                        Hiking</a></h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                ...
                                                                <h3 class="mega-menu-title"><a
                                                                        href="home-hiking-2.html"><span>10.</span>Home
                                                                        Hiking Style 2</a></h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                <div class="mega-menu-img"><img
                                                                        ...
                                                                        alt="Home ten">
                                                                    <div class="btn-wrap"><a target="_blank"
                                                                            href="home-cruise-tour.html"
                                                                            class="th-btn">View Demo</a></div>
                                                                </div>
                                                                <h3 class="mega-menu-title"><a
                                                                        href="home-cruise-tour.html"><span>11.</span>Home
                                                                        Cruise Tour</a></h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                <div class="mega-menu-img"><img
                                                                        src="assets/img/pages/home-travel-agency.jpg"
                                                                        alt="Home ten">
                                                                    <div class="btn-wrap"><a target="_blank"
                                                                ...
                                                                <h3 class="mega-menu-title"><a
                                                                        href="home-travel-agency.html"><span>12.</span>Home
                                                                        Travel Agency</a></h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                <div class="mega-menu-img"><img
                                                                        ...
                                                                        alt="Home ten">
                                                                    <div class="btn-wrap"><a target="_blank"
                                                                            href="home-museum-tour.html"
                                                                            class="th-btn">View Demo</a></div>
                                                                </div>
                                                                <h3 class="mega-menu-title"><a
                                                                        href="home-museum-tour.html"><span>13.</span>Home
                                                                        Museum Tour</a></h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                <div class="mega-menu-img"><img
                                                                        ...
                                                                        alt="Home ten">
                                                                    <div class="btn-wrap"><a target="_blank"
                                                                            href="home-worldwide-tour.html"
                                                                            class="th-btn">View Demo</a></div>
                                                                </div>
                                                                <h3 class="mega-menu-title"><a
                                                                        href="home-worldwide-tour.html"><span>14.</span>Home
                                                                        Worldwide Tour</a></h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="mega-menu-box">
                                                                <div class="mega-menu-img"><img
                                                                        ...
                                                                        alt="Home ten">
                                                                    <div class="btn-wrap"><a target="_blank"
                                                                            href="home-city-tour.html"
                                                                            class="th-btn">View Demo</a></div>
                                                                </div>
                                                                <h3 class="mega-menu-title"><a
                                                                        href="home-city-tour.html"><span>15.</span>Home
                                                                        City Tour</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="col-auto d-none d-xl-block">
                            <div class="header-button"><a href="contact.html" class="th-btn style3 th-icon">Book
                                    Now</a>
                            </div>
                        </div>
                    </div>
