...
<head>
    <meta charset="utf-8" />
    <title>@yield('title') | Cinderella Travel & Tours</title>
    ...
    <link rel="stylesheet" href="{{asset('adminAssets/libs/dropzone/dropzone.css')}}" type="text/css" />
    <link rel="stylesheet" href="{{asset('adminAssets/libs/filepond/filepond.min.css')}}" type="text/css" />
    <link rel="stylesheet" href="{{asset('adminAssets/libs/filepond-plugin-image-preview/filepond-plugin-image-preview.min.css')}}">
...
<body>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{asset('adminAssets/images/oldlogo.png')}}" alt="" height="22" />
                                </span>
                                <span class="logo-lg">
                                    <img src="{{asset('adminAssets/images/oldlogo.png')}}" alt="" height="17" />
                                </span>
                            </a>
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user" src="{{asset('adminAssets/images/defaultuser.png')}}" alt="Header Avatar" />
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="{{ route('admin.adminprofile') }}"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i>
                                    <span class="align-middle">Profile</span></a>
                                <form method="POST" action="{{route('logoutuser')}}" x-data>
                                    @csrf
                                    <button type="submit" class="dropdown-item" href="auth-lockscreen-basic.html"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i>
    ...
    <script src="{{asset('adminAssets/libs/filepond/filepond.min.js')}}"></script>
    <script src="{{asset('adminAssets/libs/filepond-plugin-image-preview/filepond-plugin-image-preview.min.js')}}"></script>
    <script src="{{asset('adminAssets/libs/filepond-plugin-file-validate-size/filepond-plugin-file-validate-size.min.js')}}"></script>
    <script src="{{asset('adminAssets/libs/filepond-plugin-image-exif-orientation/filepond-plugin-image-exif-orientation.min.js')}}"></script>
    <script src="{{asset('adminAssets/libs/filepond-plugin-file-encode/filepond-plugin-file-encode.min.js')}}"></script>
    <script src="{{asset('adminAssets/js/pages/form-file-upload.init.js')}}"></script>
    <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
    <script src="{{asset('adminAssets/libs/%40ckeditor/ckeditor5-build-classic/build/ckeditor.js')}}"></script>
