                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="col mt-3">
                                        ...
                                        <textarea class="form-control" placeholder="Enter Meta Description" name="metadescription" id="exampleFormControlTextarea5" rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#blogform').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.storeblog') }}" // Update with your route
                    , method: 'POST'
                    , data: formData
                    , processData: false
                    , contentType: false
