                        ...
                        document.querySelectorAll(".single").forEach((t) => {
                            const a = t.getBoundingClientRect(),
                                i =
                                    ...
                                    (a.x + 0.5 * a.width);
                            let n =
                                Math.abs(i) * e.translate -
                                a.width * e.translate;
                            n < 0 && (n = 0);
                            const s = i < 0 ? "left top" : "right top";
                            (t.style.transform = `translate(0, ${n}px) rotate(${-i * e.rotate
                                }deg)`),
    ...
    document.addEventListener(
                        ...
                        requestAnimationFrame(a),
                            document
                                ...
                                .forEach((a, i) => {
                                    ...
                                    (a.style.transform = `translate(0, ${o}px) rotate(${-s * t
                                        }deg)`),
        ...
        e(".destination-prev").on("click", function () {
            ...
            (t = e(
                ...
                : (t.removeClass("active"),
                    e(
                        ".destination-list-area .destination-list-wrap:last"
                    ).addClass("active"));
        }),
        e(".destination-next").on("click", function () {
            ...
            (t = e(
                ...
                : (t.removeClass("active"),
                    e(
                        ".destination-list-area .destination-list-wrap:first"
                    ).addClass("active"));
        }),
            ...
            jQuery
                ...
                .done(function (t) {
                    h.removeClass("error"),
                        ...
                        h.text(t),
                        e(
                            p + ' input:not([type="submit"]),' + p + " textarea"
                        ).val("");
                })
                .fail(function (e) {
