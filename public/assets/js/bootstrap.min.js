...
!(function (t, e) {
            ...
            return (
                ...
                (r._setActiveIndicatorElement = function (t) {
                    if (this._indicatorsElement) {
                        for (
                            var e = Y.find(".active", this._indicatorsElement),
                                n = 0;
                            n < e.length;
                            n++
                        )
    ...
    var G = "collapse",
        ...
        tt = (function (t) {
            function o(e, n) {
                ...
                for (
                    var o = Y.find('[data-bs-toggle="collapse"]'),
                        r = 0,
                        s = o.length;
                    r < s;
                    r++
            ...
            return (
                ...
                (r._getConfig = function (t) {
                    return (
                        ((t = n({}, Z, t)).toggle = Boolean(t.toggle)),
                        p(G, t, J),
                        t
                    );
                }),
    ...
    function mt(t, e) {
        ...
        if (
            i &&
            ((n = i) instanceof ut(n).ShadowRoot || n instanceof ShadowRoot)
        ) {
            var o = e;
            do {
                                        ...
                                        (t &&
                                            (("click" === t.type &&
                                                ...
                                                ("keyup" === t.type &&
                                                    "Tab" === t.key)) &&
                                            c.contains(t.target)) ||
                                        B.trigger(r, "hide.bs.dropdown", a)
                                            .defaultPrevented
                                    )
                                )
                                    "ontouchstart" in
            ...
            return (
                ...
                (r._activate = function (t) {
                    ...
                    n.classList.contains("dropdown-item")
                        ...
                        : (n.classList.add("active"),
                          Y.parents(n, ".nav, .list-group").forEach(function (
                              t
                          ) {
