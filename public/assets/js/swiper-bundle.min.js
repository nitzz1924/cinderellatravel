var Swiper = (function () {
    ...
    const pe = [
        ...
        function (e) {
            ...
            function P() {
                ...
                t.params.uniqueNavElements &&
                    ...
                    i &&
                        ((r = i.querySelector(
                            te(t.params.scrollbar.dragClass)
                        )),
                        r ||
        ...
        function (e) {
            ...
            function P(e) {
                if (("mouse" === e.pointerType && h.splice(0, h.length), !M(e)))
                    return;
            ...
            function I(e) {
                ...
                i >= 0 && h.splice(i, 1),
                    u &&
                        ...
                        g.imageEl &&
                            ((a.scale = Math.max(
                                Math.min(a.scale, g.maxRatio),
                                s.minRatio
                            )),
                            (g.imageEl.style.transitionDuration =
                                t.params.speed + "ms"),
                            (g.imageEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`),
                            (l = a.scale),
                            (o = !1),
            ...
            function A(e) {
                ...
                (v.currentX =
                    ...
                    (b.y =
                        ...
                        (Date.now() - b.prevTime) /
                        2),
                    Math.abs(v.touchesCurrent.x - b.prevPositionX) < 2 &&
                        (b.x = 0),
                    Math.abs(v.touchesCurrent.y - b.prevPositionY) < 2 &&
                        (b.y = 0),
                    ...
                    t.zoom.enabled &&
                        (function () {
                            ...
                            if (!v.isTouched || !v.isMoved)
                                return (
                                    (v.isTouched = !1), void (v.isMoved = !1)
                                );
                            ...
                            (v.minX = Math.min(g.slideWidth / 2 - d / 2, 0)),
                                ...
                                (g.imageWrapEl.style.transitionDuration =
                                    o + "ms"),
                                (g.imageWrapEl.style.transform = `translate3d(${v.currentX}px, ${v.currentY}px,0)`);
                        })();
                }),
                    ...
                    t.params.a11y.enabled &&
                        (() => {
                            ...
                            (c = T(c)),
                                ...
                                c &&
                                    c.forEach((t) =>
                                        x(t, r, e.nextSlideMessage)
                                    ),
                                p &&
                                    p.forEach((t) =>
                                        x(t, r, e.prevSlideMessage)
                                    ),
                                E() &&
